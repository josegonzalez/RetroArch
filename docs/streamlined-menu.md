...
Selecting **Favorites** from the main screen shows a list of games you have added to your favorites. You can play any game from the Favorites list just like you would from a folder: highlight it and press **A**.
...
- **Search** - Lets you find a game by typing part of its name. A keyboard opens; type a name and press Done. The menu then shows every game that matches, with artwork, just like a folder or playlist. Press **A** to start a game fresh, or **X** to pick up from your saved progress if you have any. Press **B** to type a different name, and cancel the keyboard to go back to the Options menu. When searching inside a folder, it looks through that folder and all the folders inside it. This option appears when browsing a folder, History, a playlist, or the Game Switcher.
...
- **Add to Playlist** - Shows a list of your playlists so you can add the game to one. Pick a playlist and the game is added to it. This option appears when browsing a folder, History, Favorites, a playlist, or the Game Switcher. If you are already browsing a playlist, that playlist is not shown in the list (since the game is already in it).
