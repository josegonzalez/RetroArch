...
enum msg_hash_enums
{
   ...
   MENU_LABEL(STREAMLINED_ARTWORK_TYPE),
   ...
   MENU_LABEL(CLOUD_SYNC_SYNC_ROMS),
   MENU_LABEL(CLOUD_SYNC_ROMS_SYNC_MODE),
   MENU_LABEL(CLOUD_SYNC_ROMS_SYNC_MODE_AUTOMATIC),
   MENU_LABEL(CLOUD_SYNC_ROMS_SYNC_MODE_MANUAL),
   MENU_LABEL(CLOUD_SYNC_ROMS_SYNC_MODE_ON_STARTUP),
   ...
   MENU_LABEL(CLOUD_SYNC_ROMS_SYNC_NOW),
   MENU_LABEL(CLOUD_SYNC_ROMS_RESOLVE_KEEP_LOCAL),
   MENU_LABEL(CLOUD_SYNC_ROMS_RESOLVE_KEEP_SERVER),
